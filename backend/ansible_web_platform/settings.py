...
SECRET_KEY = "django-insecure-tgmha3-a_r!h(^k$=!8n)u6uy3$pm$c&z+xb&he(gearnughup"
...
ROOT_URLCONF = "ansible_web_platform.urls"
...
WSGI_APPLICATION = "ansible_web_platform.wsgi.application"
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True, # Important for security: issues new refresh token when one is used
